...
class umEmailNotificationController {
    ...
    function __construct() {
        add_filter( 'pre_user_login',                   array( $this, 'trackValidFields' ), 99 );
        add_action( 'profile_update',                   array( $this, 'backendProfileUpdateEmail' ), 30 ); 
        ...
        add_action( 'user_meta_user_approved',          array( $this, 'userApproved' ) ); 
    ...
    function backendProfileUpdateEmail( $user_id ) {
        ...
        if ( ! ( is_admin() && ( isset( $_POST['from'] ) && $_POST['from'] == 'profile' ) ) ) return;
