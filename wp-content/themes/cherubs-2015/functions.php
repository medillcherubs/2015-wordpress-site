...
function my_admin_notice() {
  ...
  echo '<script>if (document.location.hostname === "www.cherubs2015.org" && document.location.href.indexOf("force") == -1) document.location = document.location.href.replace("www.cherubs2015.org/", "cherubs.medill.northwestern.edu/2015/")</script>';
}
