...
$wpBackendFields = array(
    ...
    array(   
        ...
        'googleplus'        => __( 'Google+', $userMeta->name ),
        'twitter'           => __( 'Twitter username', $userMeta->name ),
        'facebook'          => __( 'Facebook profile URL', $userMeta->name ),
        'google_profile'    => __( 'Google Profile URL', $userMeta->name ),
    ),
